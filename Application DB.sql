...
/****** Object:  Database [Application]    Script Date: 27-06-2024 23:05:04 ******/
CREATE DATABASE [Application]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Application', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\Application.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Application_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\Application_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Application] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [Application] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [Application] SET READ_COMMITTED_SNAPSHOT ON 
GO

ALTER DATABASE [Application] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [Application] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [Application] SET QUERY_STORE = ON
GO

ALTER DATABASE [Application] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
